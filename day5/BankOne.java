...
class BankOne {
	...
	public static void main(String[] args) {
		...
		Account a1 = new Account("kanaga",19283043403284L,5000);
		Account a2 = new Account("lakshmi",20284043403284L,6000);
		Account a3 = new Account("renu",21285043403284L,10000);
